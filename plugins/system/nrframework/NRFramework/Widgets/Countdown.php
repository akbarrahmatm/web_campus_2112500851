...
class Countdown extends Widget
{
	...
	protected $widget_options = [
		...
		// An array holding all CSS per breakpoint
		'responsive_css' => '',
	...
	private function setResponsiveCSS()
	{
		...
		// Add item padding
		if ($item_padding = \NRFramework\Helpers\Controls\Spacing::getResponsiveSpacingControlValue($this->options['item_padding'], '--item-padding', 'px'))
		{
			$responsive_css = array_merge_recursive($responsive_css, $item_padding);
		}
		...
		{
			$this->options['responsive_css'] = $responsive_css;
			$this->options['custom_css'] .= $css;
		}
	}
